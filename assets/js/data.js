window.portfolioData = {
  copy: {
    es: {
      ...
      lead: "Desarrollador web full-stack certificado en Desarrollo de Aplicaciones Web, con base real en sistemas e IT Support y orientación a bioinformática. Construyo productos claros con TypeScript, React, FastAPI, Python y R/Shiny.",
      viewCv: "Ver CV",
      cvCta: "Descargar CV",
      copyEmail: "Email",
      summary1: "Mi perfil combina desarrollo web y datos: puedo crear interfaces, APIs y herramientas internas, pero también trabajar con visualización y automatización en contextos técnicos como bioinformática.",
      summary2: "Vengo de sistemas y soporte, así que no solo hago pantallas: entiendo usuarios, incidencias, despliegue, datos y mantenimiento de software en entornos reales.",
    ...
    en: {
      ...
      navContact: "Contact",
      role: "IT & Web Developer",
      lead: "Certified full-stack web developer in Web Application Development, with a real systems and IT Support background and a bioinformatics focus. I build clear products with TypeScript, React, FastAPI, Python, and R/Shiny.",
      viewCv: "View CV",
      cvCta: "Download CV",
      copyEmail: "Email",
      summary1: "My profile connects web development and data: I can build interfaces, APIs, and internal tools, while also handling visualization and automation in technical contexts like bioinformatics.",
      summary2: "I come from systems and support, so I do more than screens: I understand users, incidents, deployment, data, and software maintenance in real environments.",
...
window.portfolioData.copy.ca = {
  ...
  navContact: "Contacte",
  lead: "Desenvolupador web full-stack certificat en Desenvolupament d'Aplicacions Web, amb base real en sistemes i IT Support i orientació a bioinformàtica. Construeixo productes clars amb TypeScript, React, FastAPI, Python i R/Shiny.",
  viewCv: "Veure CV",
  cvCta: "Descarregar CV",
  summary1: "El meu perfil uneix desenvolupament web i dades: puc crear interfícies, APIs i eines internes, però també treballar amb visualització i automatització en contextos tècnics com la bioinformàtica.",
  summary2: "Vinc de sistemes i suport, així que no només faig pantalles: entenc usuaris, incidències, desplegament, dades i manteniment de software en entorns reals.",
